...
export default function CategoriesPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const [categoriesData, mainCategoriesData] = await Promise.all([
        categoriesRes.json(),
      ...
      if (mainCategoriesData.success) {
        ...
        throw new Error(mainCategoriesData.message || "Failed to load main categories");
      }
    } catch (error) {
  ...
  const filteredCategories = categories.filter(category => {
    const matchesSearch = 
      ...
      category.maincategory?.name?.toLowerCase().includes(searchTerm.toLowerCase());
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
      ...
      <div className="p-4">
        ...
        <div className="text-sm text-gray-600 mb-3">
          Main: {category.maincategory?.name || "N/A"}
        </div>
              ...
              <div className="flex-1">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    id="search"
                    placeholder="Search by name, slug, or main category..."
                    value={searchTerm}
                          ...
                          <tr key={category._id} className="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-900">
                                {category.maincategory?.name || "N/A"}
                              </div>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span
