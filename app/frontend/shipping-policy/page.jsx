  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow border-t border-gray-400 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-20 py-12">
          {/* Breadcrumb */}
          ...
          <div className="bg-white shadow-sm rounded-lg divide-y divide-gray-200 overflow-hidden">
            <section className="p-6 md:p-8">
              ...
              <div className="ml-9 pl-1">
                <p className="text-gray-700 leading-relaxed">We currently ship across India. For international shipping inquiries, please reach out to our support team at <a href="mailto:suyta@gmail.com" className="text-blue-600 hover:underline font-medium">suyta@gmail.com</a>.  We are working towards expanding our global reach soon.</p>
              </div>
            </section>
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <a href="mailto:pydlifesciences@gmail.com" className="text-blue-600 hover:underline">suyta@gmail.com</a>
                      </li>
                      <li className="flex items-start">
                        <svg className="flex-shrink-0 h-5 w-5 text-gray-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
